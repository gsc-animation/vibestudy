    ...
    <div className="min-h-screen bg-slate-50 flex font-sans text-slate-900">
      ...
      >
        <div className="p-6 flex items-center justify-between">
          <Link href="/dashboard" className="text-2xl font-bold tracking-tight flex items-center gap-2">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="lg:hidden bg-white border-b p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={toggleSidebar} className="p-2 -ml-2 rounded-lg hover:bg-slate-100 text-slate-600">
              <Menu size={24} />
            </button>
